                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    {{ Str::words($product->description, 5) }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex items-center space-x-4">
                                                        ...
                                                        <button id="deleteProductModal{{ $product->id }}"
                                                            data-modal-target="deleteProductModal{{ $product->id }}"
                                                        ...
                                                        <form action="{{ route('products.update', $product->slug) }}"
                                                            ...
                                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                                ...
                                                                <div class="sm:col-span-2">
                                                                    ...
                                                                    <textarea name="description" id="description{{ $product->id }}" rows="4"
                                            ...
                                            <!-- Main modal -->
                                            <div id="deleteProductModal{{ $product->id }}" tabindex="-1"
                                                aria-hidden="true"
                                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
