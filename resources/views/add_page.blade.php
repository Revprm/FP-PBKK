<x-layout>
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            <div class="py-2">
                <a href="/dashboard" class="font-medium text-xm text-blue-500 hover:underline">&laquo; Back to Dashboard
                    Page</a>
            </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="8"
                            class="block p-2.5 w-full text-sm bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            placeholder="Your description here" required=""></textarea>
                    </div>
                </div>
                <button type="submit"
                    class="inline-flex items-center px-5 py-2.5 mt-4 text-sm font-medium text-white bg-primary-700 rounded-lg hover:bg-primary-800">
                    Add product
                </button>
            </form>
        </div>
